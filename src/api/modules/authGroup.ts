...
export const authGroupList = params => {
  return http.get("/authGroup/list", params, { loading: false });
};
//权限组管理-查询授权人员
export const authGroupQueryUser = params => {
  return http.get("/authGroup/query/user", params, { loading: false });
};
//权限组管理 - 删除授权人员;
export const authGroupDeleteUser = params => {
  return http.post("/authGroup/delete/user", params, { loading: false });
};
//权限组管理-删除权限组
export const authGroupDeleteGroup = params => {
  return http.post("/authGroup/delete/group", params, { loading: false });
};
//权限组管理-更新是否是审核组
export const authGroupUpdateAuditFlag = params => {
  return http.post("/authGroup/update/auditFlag", params, { loading: false });
};
//权限组管理 - 更新用户注册时展示;
export const authGroupUpdateDisplayFlag = params => {
  return http.post("/authGroup/update/displayFlag", params, { loading: false });
};
//权限组管理-添加权限组
export const authGroupAddGroup = params => {
  return http.post("/authGroup/add/group", params, { loading: false });
};
//权限组管理-编辑权限组
