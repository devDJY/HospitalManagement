  ...
  <div class="table-box">
    <ProTable ref="proTable" :columns="columns" :request-api="getTableList" :init-param="initParam" @drag-sort="sortTable">
      ...
      <template #operation="scope">
        <!-- <el-button type="primary" link :icon="View" @click="openDrawer('查看', scope.row)">审核</el-button>
        <el-button type="primary" link :icon="EditPen" @click="openDrawer('编辑', scope.row)">编辑</el-button> -->
        <el-button type="primary" link :icon="Refresh" @click="resetPass(scope.row)">回收审核</el-button>
...
const columns = reactive<ColumnProps<User.ResUserList>[]>([
  ...
  { prop: "expand", label: "文件编码", width: 85, search: { el: "input" } },
  { prop: "expand", label: "文件受控编码", width: 85, search: { el: "input" } },
  { prop: "idCard", label: "源文件" },
  { prop: "idCard", label: "受控文件" },
  { prop: "idCard", label: "文件受控编码" },
  { prop: "idCard", label: " 文件页数" },
  { prop: "address", label: "回收原因" },
  { prop: "address", label: "回收说明" },
  { prop: "address", label: "附件" },
  { prop: "address", label: "申请人" },
